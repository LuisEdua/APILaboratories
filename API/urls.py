...
from .views import MeasuresView, SessionView, AdminsView, ManagerView, DispositiveView, EmailView, measure_list

urlpatterns = [
    path('measures/', MeasuresView.as_view(), name='measures_list'),
    path('measures/<int:id>/', measure_list, name='measures_process'),
